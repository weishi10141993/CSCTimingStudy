...
class CruzetMacro_TOF_v3: public L1Ntuple
{
  public :

    //constructor    
    CruzetMacro_TOF_v3(std::string filename) : L1Ntuple(filename) {}
    CruzetMacro_TOF_v3() {}
    ~CruzetMacro_TOF_v3() {}
...
//                             run function 
// --------------------------------------------------------------------
void CruzetMacro_TOF_v3::run(Long64_t nevents){
   ...
   //write all plots in the new root file
    TFile myFile("/afs/cern.ch/work/w/wshi/public/TimingStudy/TimingStudy_TOF_v3.root","RECREATE");
    ...
    C1->cd();
    C1->SetGrid();
    myGraph->SetTitle("CSCTF LCT BX in ME+1/1 with TOF Correction");
 ...
 // chamber1_bx_plot->Draw();
  ...
  myFile.Close();
  cout<<"/afs/cern.ch/work/w/wshi/public/TimingStudy/TimingStudy_TOF_v3.root finished!"<<endl;
    cout<<"********************************************"<<endl;

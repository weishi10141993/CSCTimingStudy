...
class CruzetMacro_TOF_SPT: public L1Ntuple
{
  public :

    //constructor    
    CruzetMacro_TOF_SPT(std::string filename) : L1Ntuple(filename) {}
    CruzetMacro_TOF_SPT() {}
    ~CruzetMacro_TOF_SPT() {}
...
//                             run function 
// --------------------------------------------------------------------
void CruzetMacro_TOF_SPT::run(Long64_t nevents){
   ...
   //write all plots in the new root file
    TFile myFile("/afs/cern.ch/work/w/wshi/public/TimingStudy/TimingStudy_TOF_SPT.root","RECREATE");
 ...
 // chamber1_bx_plot->Draw();
  ...
  myFile.Close();
  cout<<"/afs/cern.ch/work/w/wshi/public/TimingStudy/TimingStudy_TOF_SPT.root finished!"<<endl;
    cout<<"********************************************"<<endl;
